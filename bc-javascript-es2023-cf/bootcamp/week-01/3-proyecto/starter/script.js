...
console.log('=========================================');
console.log('SERVICIOS FINTECH - FICHA #026');
console.log('=========================================');
console.log('');
...
console.log('nombre: servicios financieros ');
console.log('direcccion: carrera 18 este #90-18 sur, bogota');
console.log('telefono: 345678901 ');
console.log('IDT: SERFIZ26')
...
console.log('años de servicio', 10 );
...
console.log('tasa de interes',  2000000 * 0.15 );
...
console.log('Valor calculado:    ', 1500000 - 250000); // TODO: reemplaza 0 con tu cálculo, saldo restante para pagar una cuota
...
console.log('Total registros:', 150000);
...
console.log('financias: ¡ Explora tus finanzas con la mano de javaScript! ');
