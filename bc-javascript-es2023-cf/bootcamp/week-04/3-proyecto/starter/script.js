...
const entityCategory = "Finanzas";

// TODO: Define un código identificador (string)
// Elige un prefijo coherente con tu dominio
const entityCode = "FINPAGX-022";

// TODO: Define una descripción corta (string)
// Debe contener varias palabras para usar includes/slice
const entityDescription = "Este elemento representa las transacciones financieras realizadas en la plataforma FinPagX, incluyendo detalles como monto, fecha y tipo de transacción.";
